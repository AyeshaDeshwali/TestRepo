      ...
      //      }
      //      }
      //  12. pritn 1 to 100, but with a specific condition. If a number is divisible by both 3 and 5, it logs "fizzbuzz" to the console instead of the number itself.
      //   for (i = 1; i <= 100; i = i + 1) {
      //     if (i % 3 === 0 && i % 5 === 0) {
      //       console.log(i + "fizzbuzz");
      //     }
      //   }
      //  13. print 10 table like this
      //   2*1=2
      //   2*2=4
      //   2*3=6
      //   2*4=8
      ...
      //   6.
      //   let i = Number(prompt("please gues a number"));
      //   while (i != 20) {
